...
### Lighthouse
I have tested the code using Google DevTools lighthouse to see how fast my site loads. From these results it shows the site is not doing well on this aspect, this will need to be corrected.
